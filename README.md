...
docfill первоначально создан как консольная утилита (программа для интерфейса командной строки), однако имеет опциональную надстройку в виде графического интерфейса на базе tkinter.
